...
Widget customerPersonalInformationCard({
  text = "...",
  ...
  return InkWell(
    onTap: () {
      leadsController.customerPersonalInformationController.text = text;
      leadsController.update();
    },
    child: Container(
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: leadsController.customerPersonalInformationController.text != text
      ...
      child: Center(
        child: customText(
          text: text,
          textColor:
              leadsController.customerPersonalInformationController.text != text ? Colors.black : textColor,
          fontSize: fontSize,
