          ...
          children: [
            Padding(
              ...
              child: customInputTextfield(
                ...
                controller: leadsController.portingRequestNameController[index],
                label: "Name",
              ),
            ),
            Padding(
              ...
              child: customInputTextfield(
                validator: fieldValidator,
                controller:
                    leadsController.portingRequestPhoneNumberController[index],
                label: "Phone Number",
              ),
            ),
            Padding(
            ...
            Padding(
              ...
              child: customInputTextfield(
                validator: fieldValidator,
                controller:
                    leadsController.portingRequestDeviceNameController[index],
                label:
